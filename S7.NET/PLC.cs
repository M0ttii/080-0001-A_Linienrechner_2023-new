...
namespace S7
{
    public class PLC
    {
        ...
        public int IsAvailablePingTimeout { get; set; } = 1000;
        ...
        public bool IsAvailable
        {
            ...
            {
                Ping ping = new Ping();
                PingReply result = ping.Send(IP, IsAvailablePingTimeout);
        ...
        public PLC(CPU_Type cpu, string ip, Int16 rack, Int16 slot, int isAvailablePingTimeout)
        {
            IP = ip;
            CPU = cpu;
            Rack = rack;
            Slot = slot;
            IsAvailablePingTimeout = isAvailablePingTimeout;
        }
        ...
        /// <summary>
        /// Öffnet eine Verbindung zur SPS
        /// </summary>
        /// <returns>
        /// Ablauf
        /// 1. Checkt die Möglichkeit der Verbindung durch ein Ping.
        /// 2. Erstellt und konfiguriert Socket und öffnet die Verbindung
        /// 3. Setzt die Initialdaten auf der SPS
        /// </returns>
        public ErrorCode Open()
        {
            ...
            catch (Exception e)
            {
                ...
                lastErrorString = "Destination IP-Address '" + IP + "' is not available! Error = " + e.Message.ToString();
        ...
        /// <summary>
        /// Liest die Bytes von der SPS aus.
        /// </summary>
        /// <param name="DataType"></param>
        /// <param name="DB">DatenBaustein</param>
        ...
        public byte[] ReadBytes(DataType DataType, int DB, int StartByteAdr, int count)
        {
            ...
            try
            {
                ...
                //übertragen der Empfangenen Daten in das zurück zugebende Byte-Array
                for (int i = 0; i < count; ++i)
                    bytes[i] = bReceive[i + 25];
        ...
        public object Read(DataType DataType, int DB, int StartByteAdr, VarType VarType, int VarCount)
        {
            ...
            //removed weil nicht erreichbarer Code
            //return null;
        }
        #endregion
